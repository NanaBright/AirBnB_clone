...
prompt = "(hbnb) "
lnt_cls = ['BaseModel', 'User', 'Amenity', 'Place', 'City', 'State', 'Review']

lnt_c = ['create', 'show', 'update', 'all', 'destroy', 'count']
...
def precmd(self, arg):
    ...
    if '.' in arg and '(' in arg and ')' in arg:
        ...
        cnd = cls[1].split('(')
        args = cnd[1].split(')')
        if cls[0] in HBNBCommand.lnt_cls and cnd[0] in HBNBCommand.lnt_c:
...
def do_count(self, cls_name):
    ...
    if not type_model:
    ...
    elif type_model not in HBNBCommand.lnt_cls:
        ...
        def do_show(self, arg):
            ...
            if args[0] not in HBNBCommand.lnt_cls:
                print("** class doesn't exist **")
            elif len(args) == 1:
